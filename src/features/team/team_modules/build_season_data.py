...
def parse_single_season_team_data(dataframe):
    ...
    dataframe.drop(labels=['Conf. wins', 'Conf. losses', 'MP', 'ORB', 'Rk', 'Unnamed: 16', 'Home wins', 'Home losses', 'Away wins', 'Away losses', 'Points against', 'TRB', 'TOV', 'PF'], inplace=True, axis=1)
